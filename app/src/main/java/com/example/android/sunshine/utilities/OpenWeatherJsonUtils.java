...
public final class OpenWeatherJsonUtils {
    ...
    private final static int EARLY_MORNING = 3;
    private final static int DAWN = 6;
    private final static int MID_MORNING = 9;
    private final static int NOON = 12;
    private final static int AFTERNOON = 15;
    private final static int EVENING = 18;
    private final static int NIGHT = 21;
    private final static int MID_NIGHT = 0;
    ...
    private static final String OWM_DATE = "dt_txt";
...
//        long normalizedUtcStartDay = SunshineDateUtils.normalizeDate(now);
        ...
        for (int i = 0; i < jsonWeatherArray.length(); i++) {
            ...
            JSONObject dayForecast = jsonWeatherArray.getJSONObject(i);//i);
            if (dayForecast.has(OWM_DATE))
                date = dayForecast.getString(OWM_DATE);
            assert date != null;
            int index = date.indexOf(" ");
            int currentString = Integer.valueOf(date.substring(index + 1, index + 3));
            ...
            long givenDateString = normalizedUtcStartDay + SunshineDateUtils.DAY_IN_MILLIS * n;
            ...
            weatherValues.put(WeatherContract.WeatherEntry.COLUMN_DATE, givenDateString);
            ...
            weatherContentValues[n] = weatherValues;
            n++;
            if (n == 5) {
                n = 0;
                break;
